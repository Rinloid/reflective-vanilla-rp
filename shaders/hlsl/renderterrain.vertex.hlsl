...
PSInput.isWater = false;
PSInput.worldPosition = VSInput.position.xyz;
...
PSInput.cameraPosition = worldPos.xyz;
...
///// find distance from the camera
	...
	PSInput.fogFactor = clamp((len - FOG_CONTROL.x) / (FOG_CONTROL.y - FOG_CONTROL.x), 0.0, 1.0);
